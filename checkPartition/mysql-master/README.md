...
## Usage
(需上传本驱动至项目路径内并修改项目的go.mod，新增:
replace github.com/go-sql-driver/mysql v1.7.0 => ./myimport/mysql-master
其中 v1.7.0 为go.mod中require的原生驱动版本， ./myimport 为本驱动所在的相对路径， mysql-master为驱动名)
